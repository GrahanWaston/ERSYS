                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="activity" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link" href="management-activity.html"><i class="align-middle" data-feather="chevron-right"></i>Activity</a></li>
                            <li class="sidebar-item"><a class="sidebar-link" href="management-subactivity.html"><i class="align-middle" data-feather="chevron-right"></i>Sub Activity</a></li>
                        </ul>
                    </li>
